...
def main():
    ...
    if 'chat_history2_docs' not in st.session_state:
        st.session_state.chat_history2_docs = []
    ...
    if button_clicked_1:
        if raw_text and not csv_files:
            ...
            if fig.get_axes():
                st.session_state.chat_history2.append((st.session_state.input, fig))
            
            else:
                st.session_state.chat_history2.append((st.session_state.input, x))
            ...
            try:
                ...
                if fig.get_axes():
                    ...
                    st.session_state.chat_history2.append((st.session_state.input, x))
                    st.session_state.chat_history2_docs.append((st.session_state.input, str(x)))
    ...
    for message in st.session_state.chat_history2[::-1]:
        if message[0]:
